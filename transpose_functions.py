...
def chord_line(line):
    ...
    excluded_characters = ["h","i","j","k","l","n","o","p","q","r","s","t","u","v","x","y","z"]
    chord_characters = ["#", "7", "/"]
    ...
    for letter in line:
        ...
        #excluded characters
        if letter.lower() in excluded_characters:
            excluded_count += 1
        elif letter in chord_characters:
            chord_count += 1

    #heuristic formula for determining likelihood of chord line
    score = (upper_count - lower_count) + (space_count - letter_count) - 4 * excluded_count + chord_count
